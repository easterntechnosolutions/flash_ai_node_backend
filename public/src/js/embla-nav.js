export const addDotBtnsAndClickHandlers = (
      ...
      .map(
        () => `
				<button 
					type="button"
					class="
						embla-nav__dot w-[70px] xs:w-[82px] h-1 xl:w-1 xl:h-[82px] bg-gray-500 data-[active=true]:bg-aqua-500 rounded-full 
  ...
  const toggleDotBtnsActive = () => {
    ...
    if (currentSlideCounterNode)
      currentSlideCounterNode.innerText = `0${
